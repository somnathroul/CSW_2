...
public class Q21 {
    ...
    public static void Multiplication(int arr[][], int arr1[][], int m, int n, int p)
            throws ArrayIndexOutOfBoundsException {
        int sum[][] = new int[m][p];
        if (n != arr1.length) {
            throw new ArrayIndexOutOfBoundsException(
                    "Matrix multiplication not possible: Number of columns in first matrix must be equal to the number of rows in the second matrix");
        }
        for (int i = 0; i < m; i++) {
            for (int j = 0; j < p; j++) {
